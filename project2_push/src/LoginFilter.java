...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        System.out.println("Session - " + httpRequest.getSession().getAttribute("user"));
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        System.out.println("This time -> "+requestURI);
        return requestURI.endsWith("login.html") || requestURI.endsWith("login.js")
                || requestURI.endsWith("login")||requestURI.contains("search_result");
    }
